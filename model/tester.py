...
class App:
    def __init__(self):
        ...
        self.scrollPane.grid(row=1, column=0, sticky='nswe', pady=(20,80), padx=20)
        ...
        self.metaDataDetails.columnconfigure(0, weight=4)
        ...
        self.imageScrollPane.pack(fill='both', expand=True)
